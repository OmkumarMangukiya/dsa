...
void levelOrderTraversal(node* root){
    ...
    while (!q.empty())
    {
        ...
        if(temp==nullptr){ 
            ...
            // We push another NULL to mark the end of this next level. This is the "second" NULL push.
            // This process continues, ensuring each level of the tree is printed on a new line.
            if(!q.empty()){
                q.push(nullptr);
            }
        }
